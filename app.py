...
def get(city):
    ...
    url = 'https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWA-4A8C2179-9849-40EB-947F-FD750B13862E&format=JSON&locationName=' + str(city)
